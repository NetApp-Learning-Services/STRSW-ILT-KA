...
func (r *ReconcileVisitorApp) ensureDeployment(request reconcile.Request,
...
func (r *ReconcileVisitorApp) ensureService(request reconcile.Request,
	instance *examplev1.VisitorApp,
	s *corev1.Service,
) (*reconcile.Result, error) {
...
func (r *ReconcileVisitorApp) ensureSecret(request reconcile.Request,
	instance *examplev1.VisitorApp,
	s *corev1.Secret,
) (*reconcile.Result, error) {
	found := &corev1.Secret{}
...
func labels(v *examplev1.VisitorApp, tier string) map[string]string {
